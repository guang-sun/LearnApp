...
@implementation TrainBrightnessView

+ (instancetype)sharedBrightnessView {
    static TrainBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TrainBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        self.frame = CGRectMake(TrainSCREENWIDTH * 0.5, TrainSCREENHEIGHT * 0.5, 155, 155);
        ...
        self.backImage = ({
            ...
            imgView.image        = TrainPlayerImage(@"TrainPlayer_brightness");
...
- (void)layoutSubviews {
    ...
    self.center = CGPointMake(TrainSCREENWIDTH * 0.5, TrainSCREENHEIGHT * 0.5);
}
