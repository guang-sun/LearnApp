...
#import "TrainWaitingView.h"
#import "UIImageView+WebCache.h"

@interface TrainPhotoBrowserView() <UIScrollViewDelegate>
@property (nonatomic,strong) TrainWaitingView *waitingView;
...
@implementation TrainPhotoBrowserView
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    TrainWaitingView *waitingView = [[TrainWaitingView alloc] init];
    waitingView.mode = TrainWaitingViewModeLoopDiagram;
    ...
    [_imageview sd_setImageWithURL:url placeholderImage:placeholder options:SDWebImageAllowInvalidSSLCertificates progress:^(NSInteger receivedSize, NSInteger expectedSize) {
